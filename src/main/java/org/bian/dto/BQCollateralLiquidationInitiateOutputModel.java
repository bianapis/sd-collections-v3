...
/**
 * BQCollateralLiquidationInitiateOutputModel
 */
public class BQCollateralLiquidationInitiateOutputModel   {
  private String collateralLiquidationInstanceReference = null;

  private String collateralLiquidationInitiateActionReference = null;
  ...
  **/
   ...
   * @return collateralLiquidationInitiateActionReference
  **/

  public String getCollateralLiquidationInitiateActionReference() {
    return collateralLiquidationInitiateActionReference;
  }

  public void setCollateralLiquidationInitiateActionReference(String collateralLiquidationInitiateActionReference) {
    this.collateralLiquidationInitiateActionReference = collateralLiquidationInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Collateral Liquidation instance (e.g. initialised, pending, active) 
