...
/**
 * BQCollateralValuationExchangeOutputModel
 */
public class BQCollateralValuationExchangeOutputModel   {
  ...
  private String collateralValuationExchangeActionTaskReference = null;

  private Object collateralValuationExchangeActionTaskRecord = null;

  private String collateralValuationExchangeActionResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Collateral Valuation instance exchange service call 
   * @return collateralValuationExchangeActionTaskReference
  **/

  public String getCollateralValuationExchangeActionTaskReference() {
    return collateralValuationExchangeActionTaskReference;
  }

  public void setCollateralValuationExchangeActionTaskReference(String collateralValuationExchangeActionTaskReference) {
    this.collateralValuationExchangeActionTaskReference = collateralValuationExchangeActionTaskReference;
  }
  ...
  **/
   ...
   * @return collateralValuationExchangeActionResponse
  **/

  public String getCollateralValuationExchangeActionResponse() {
    return collateralValuationExchangeActionResponse;
  }

  public void setCollateralValuationExchangeActionResponse(String collateralValuationExchangeActionResponse) {
    this.collateralValuationExchangeActionResponse = collateralValuationExchangeActionResponse;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Collateral Valuation instance (e.g. accepted, rejected, verified) 
